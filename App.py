# -*- coding: utf-8 -*-
"""Project_III_Final.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UQtX_Wfjqe-jCzckvw9LtxjEzYGtEGdH
...
def upgrade_pip_and_install_packages():
    ...
    print("Upgrading pip...")
    subprocess.run([sys.executable, "-m", "pip", "install", "--upgrade", "pip"], stdout=subprocess.PIPE, stderr=subprocess.DEVNULL)
    print("Pip upgraded successfully.")

    packages = [
        'streamlit', 'vosk', 'yt-dlp', 'tqdm', 'datasets', 'python-dotenv',
        'openai', 'pinecone-client', 'tiktoken', 'pyarrow'
    ]

    for package in packages:
        print(f"Installing {package}...")
        subprocess.run([sys.executable, "-m", "pip", "install", package], stdout=subprocess.PIPE, stderr=subprocess.DEVNULL)
